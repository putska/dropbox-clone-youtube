  ...
  return (
    <main className="">
      <div className="flex flex-col lg:flex-row items-center bg-[#1E1919] dark:bg-slate-800">
        <div className="p-10 flex flex-col bg-[#2B2929] dark:bg-slate-800 text-white space-y-5">
          ...
          <p className="pb-20">
            ...
            Securely store important documents, photos, videos, and more and
      ...
      <p className="text-center font-light p-2">
        ...
        do not own or affiliate with Dropbox or/and any of their susidiaries in
        any form. Copyright disclaimer under section 107 of the Copyright act of
        1976, allowance is made for "fair use" of this vdeo for educational
        purposes
      </p>
    </main>
  );
